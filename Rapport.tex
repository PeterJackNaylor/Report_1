...
%I started my PhD by focusing on the Camelyon2016 dataset. This dataset was very interesting as it is similar to the ones I will be using. The tissue samples were acquired from breast tissue with a Philips scanner. Tackling this segmentation problem was very interesting as it was my first opportunity to tackle a metastasis detection challenge with a huge amount of segmentation annotation, which is fairly rare.
